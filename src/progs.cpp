...
void PR_AutoCvarChanged(
    cvar::CVar *var); // updates the autocvar_ globals when their cvar is changed
...
#define G_EDICT(o) ((EntityDict *)((byte *)qcvm->edicts + *(int *)&qcvm->globals[o]))
...
extern cvar::CVar pr_checkextension; // if 0, extensions are disabled (unless they'd
...
#define LOCALSTACK_SIZE 16384 /* was 2048*/
  ...
  EntityDict *edicts;   // can NOT be array indexed, because EntityDict is variable
