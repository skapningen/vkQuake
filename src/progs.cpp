...
struct EntityDict {
  ...
  bool free;
  struct EntityDict *prev_free;
  struct EntityDict *next_free;
...
#define EDICT_FROM_AREA(l) STRUCT_FROM_LINK(l, EntityDict, area)

constexpr size_t LOCALSTACK_SIZE = 16384;
...
struct extfields_t { // various fields that might be wanted by the engine. -1
                     // == invalid
...
struct QCVm {
  ...
  extglobals_t extglobals;
  extfuncs_t extfuncs;
  extfields_t extfields;
  ...
  EntityDict
      *edicts; // can NOT be array indexed, because EntityDict is variable
               // sized, but can be used to reference the world ent
  EntityDict *free_edicts_head;
  EntityDict *free_edicts_tail;
...
void PR_AutoCvarChanged(cvar::CVar *var); // updates the autocvar_ globals when
                                          // their cvar is changed
...
EntityDict *ED_Alloc(void);
void ED_Free(EntityDict *ed);
void ED_RemoveFromFreeList(EntityDict *ed);

void ED_Print(EntityDict *ed);
void ED_Write(FILE *f, EntityDict *ed);
const char *ED_ParseEdict(const char *data, EntityDict *ent);
...
/*
#define EDICT_NUM(n)		((EntityDict *)(sv.edicts+ (n)*pr_edict_size))
#define NUM_FOR_EDICT(e)	(((byte *)(e) - sv.edicts) / pr_edict_size)
*/
EntityDict *EDICT_NUM(int32_t n);
int32_t NUM_FOR_EDICT(EntityDict *e);

#define NEXT_EDICT(e) ((EntityDict *)((byte *)e + qcvm->edict_size))

#define EDICT_TO_PROG(e) ((byte *)e - (byte *)qcvm->edicts)
#define PROG_TO_EDICT(e) ((EntityDict *)((byte *)qcvm->edicts + e))

#define G_FLOAT(o) (qcvm->globals[o])
#define G_INT(o) (*(int *)&qcvm->globals[o])
#define G_EDICT(o)                                                             \
  ((EntityDict *)((byte *)qcvm->edicts + *(int *)&qcvm->globals[o]))
...
Val *GetEdictFieldValue(EntityDict *ed,
...
constexpr size_t VANILLA_AREA_DEPTH = 4;
// #define VANILLA_AREA_DEPTH 4
constexpr size_t MAX_AREA_DEPTH = 9;
// #define MAX_AREA_DEPTH 9
constexpr size_t AREA_NODES = 2 << MAX_AREA_DEPTH;
