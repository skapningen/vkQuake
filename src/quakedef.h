...
#define VKQUAKE_VER_STRING                                                     \
  QS_STRINGIFY(VKQUAKE_VERSION)                                                \
  "." QS_STRINGIFY(VKQUAKE_VER_PATCH) VKQUAKE_VER_SUFFIX
...
#define PSET_SCRIPT // enable the scriptable particle system (poorly ported from
                    // FTE)
#define PSET_SCRIPT_EFFECTINFO // scripted particle system can load dp's effects

#define LERP_BANDAID // HACK: send think interval over FTE protocol (loopback
                     // only, no demos)
