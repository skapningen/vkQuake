...
static inline uint8_t Atomic_OrUInt8(volatile atomic_uint8_t *atomic,
                                     uint8_t val) {
...
static inline void Atomic_StoreUInt32(volatile atomic_uint32_t *atomic,
                                      uint32_t desired) {
  atomic->value = desired;
  _ReadBarrier();
}

static inline bool Atomic_CompareExchangeUInt32(atomic_uint32_t *atomic,
                                                uint32_t *expected,
                                                uint32_t desired) {
  const uint32_t actual = InterlockedCompareExchange(
      (volatile LONG *)&atomic->value, desired, *expected);
  if (actual == *expected) {
    return true;
  }
  *expected = actual;
...
static inline uint32_t Atomic_AddUInt32(volatile atomic_uint32_t *atomic,
                                        uint32_t value) {
  return InterlockedAdd((volatile LONG *)&atomic->value, value) - value;
}

static inline uint32_t Atomic_SubUInt32(volatile atomic_uint32_t *atomic,
                                        uint32_t value) {
  return InterlockedAdd((volatile LONG *)&atomic->value, ~value + 1) + value;
}

static inline uint32_t Atomic_OrUInt32(volatile atomic_uint32_t *atomic,
                                       uint32_t val) {
  return InterlockedOr((volatile LONG *)&atomic->value, val);
}

static inline uint32_t
Atomic_IncrementUInt32(volatile atomic_uint32_t *atomic) {
  return InterlockedIncrement((volatile LONG *)&atomic->value) - 1;
}

static inline uint32_t
Atomic_DecrementUInt32(volatile atomic_uint32_t *atomic) {
...
static inline void Atomic_StoreUInt64(atomic_uint64_t *atomic,
                                      uint64_t desired) {
  atomic->value = desired;
  _ReadBarrier();
}

static inline bool Atomic_CompareExchangeUInt64(atomic_uint64_t *atomic,
                                                uint64_t *expected,
                                                uint64_t desired) {
  const uint64_t actual = InterlockedCompareExchange64(
      (volatile LONG64 *)&atomic->value, desired, *expected);
  if (actual == *expected) {
    return true;
  }
  *expected = actual;
...
Atomic_IncrementUInt64(volatile atomic_uint64_t *atomic) {
  return InterlockedIncrement64((volatile LONG64 *)&atomic->value) - 1;
}

static inline uint64_t Atomic_AddUInt64(volatile atomic_uint64_t *atomic,
                                        uint64_t value) {
  return InterlockedAdd64((volatile LONG64 *)&atomic->value, value) - value;
}

static inline uint64_t Atomic_SubUInt64(volatile atomic_uint64_t *atomic,
                                        uint64_t value) {
  return InterlockedAdd64((volatile LONG64 *)&atomic->value, (~value) + 1) +
         value;
}
#else
...
static inline void Atomic_StoreUInt32(atomic_uint32_t *atomic,
                                      uint32_t desired) {
  atomic_store(atomic, desired);
}

static inline uint32_t Atomic_AddUInt32(atomic_uint32_t *atomic,
                                        uint32_t value) {
  return atomic_fetch_add(atomic, value);
}

static inline uint32_t Atomic_SubUInt32(atomic_uint32_t *atomic,
                                        uint32_t value) {
  return atomic_fetch_sub(atomic, value);
}

static inline uint32_t Atomic_OrUInt32(atomic_uint32_t *atomic,
                                       uint32_t value) {
...
static inline uint64_t Atomic_AddUInt64(atomic_uint64_t *atomic,
                                        const uint64_t value) {
  return atomic_fetch_add(atomic, value);
}

static inline uint64_t Atomic_SubUInt64(atomic_uint64_t *atomic,
                                        const uint64_t value) {
  return atomic_fetch_sub(atomic, value);
}
#endif
