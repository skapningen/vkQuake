...
void Draw_Pic(cb_context_t *cbx, int x, int y, qpic_t *pic, float alpha,
              bool alpha_blend);
void Draw_SubPic(cb_context_t *cbx, float x, float y, float w, float h,
                 qpic_t *pic, float s1, float t1, float s2, float t2,
                 float *rgb, float alpha);
void Draw_TransPicTranslate(cb_context_t *cbx, int x, int y, qpic_t *pic,
                            int top, int bottom); // johnfitz -- more parameters
void Draw_ConsoleBackground(
    cb_context_t *cbx); // johnfitz -- removed parameter int lines
void Draw_TileClear(cb_context_t *cbx, int x, int y, int w, int h);
void Draw_Fill(cb_context_t *cbx, int x, int y, int w, int h, int c,
...
void Draw_String_3D(cb_context_t *cbx, vec3_t coords, float size,
                    const char *str);
...
void GL_Viewport(cb_context_t *cbx, float x, float y, float width, float height,
