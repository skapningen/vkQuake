...
int SV_PointContentsAllBsps(vec3_t p,
                            edict_t *forent); // check all SOLID_BSP ents
...
#define CONTENTMASK_ANYSOLID                                                   \
  (CONTENTMASK_FROMQ1(CONTENTS_SOLID) | CONTENTMASK_FROMQ1(CONTENTS_CLIP))
...
bool SV_RecursiveHullCheck(hull_t *hull, vec3_t p1, vec3_t p2, trace_t *trace,
