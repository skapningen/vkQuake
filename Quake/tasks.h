...
void Task_AssignFunc(task_handle_t handle, task_func_t func, void *payload,
                     size_t payload_size);
void Task_AssignIndexedFunc(task_handle_t handle, task_indexed_func_t func,
...
bool Task_Join(task_handle_t handle, uint32_t timeout);

static inline task_handle_t Task_AllocateAndAssignFunc(task_func_t func,
                                                       void *payload,
                                                       size_t payload_size) {
...
static inline task_handle_t
Task_AllocateAndAssignIndexedFunc(task_indexed_func_t func, uint32_t limit,
...
static inline task_handle_t
Task_AllocateAssignFuncAndSubmit(task_func_t func, void *payload,
                                 size_t payload_size) {
  task_handle_t handle = Task_Allocate();
  Task_AssignFunc(handle, func, payload, payload_size);
  Task_Submit(handle);
...
static inline task_handle_t
Task_AllocateAssignIndexedFuncAndSubmit(task_indexed_func_t func,
                                        uint32_t limit, void *payload,
                                        size_t payload_size) {
  task_handle_t handle = Task_Allocate();
  Task_AssignIndexedFunc(handle, func, limit, payload, payload_size);
  Task_Submit(handle);
